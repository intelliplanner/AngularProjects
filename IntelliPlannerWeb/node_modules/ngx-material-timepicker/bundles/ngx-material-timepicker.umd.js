(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('rxjs/operators'), require('@angular/animations'), require('luxon'), require('@angular/forms'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('ngx-material-timepicker', ['exports', '@angular/core', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/animations', 'luxon', '@angular/forms', '@angular/platform-browser'], factory) :
    (global = global || self, factory(global['ngx-material-timepicker'] = {}, global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators, global.ng.animations, global.luxon, global.ng.forms, global.ng.platformBrowser));
}(this, function (exports, core, common, rxjs, operators, animations, luxon, forms, platformBrowser) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxMaterialTimepickerContentComponent = /** @class */ (function () {
        ...
        NgxMaterialTimepickerContentComponent.prototype.ngOnInit = function () {
            this.animationState = !this.disableAnimation && exports.ɵz.ENTER;
            this.defineTime();
        ...
        NgxMaterialTimepickerContentComponent.prototype.close = function () {
            ...
            this.animationState = exports.ɵz.LEAVE;
        };
        NgxMaterialTimepickerContentComponent.prototype.animationDone = function (event) {
            if (event.phaseName === 'done' && event.toState === exports.ɵz.LEAVE) {
                this.timepickerBaseRef.close();
            }
        };
    ...
    exports.ɵp = StyleSanitizerPipe;
    exports.ɵq = TimeFormatterPipe;
    exports.ɵr = OverlayDirective;
    exports.ɵs = AutofocusDirective;
    exports.ɵt = MinutesFormatterPipe;
    exports.ɵu = NgxTimepickerTimeControlComponent;
    exports.ɵv = NgxTimepickerPeriodSelectorComponent;
    exports.ɵw = TimeLocalizerPipe;
    exports.ɵx = ActiveHourPipe;
    exports.ɵy = ActiveMinutePipe;
