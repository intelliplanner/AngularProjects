...
import { LabelOptions, RippleGlobalOptions } from "@angular/material/core";
...
export declare class DynamicMaterialChipsComponent extends DynamicFormControlComponent {
    ...
    matInput: MatInput;
    constructor(layoutService: DynamicFormLayoutService, validationService: DynamicFormValidationService, AUTOCOMPLETE_OPTIONS: MatAutocompleteDefaultOptions, CHIPS_OPTIONS: MatChipsDefaultOptions, LABEL_OPTIONS: LabelOptions, RIPPLE_OPTIONS: RippleGlobalOptions);
