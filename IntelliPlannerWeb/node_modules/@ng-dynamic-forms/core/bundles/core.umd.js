(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/forms'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@ng-dynamic-forms/core', ['exports', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/forms', '@angular/common'], factory) :
    (global = global || self, factory((global.ngDynamicForms = global.ngDynamicForms || {}, global.ngDynamicForms.core = {}), global.rxjs, global.rxjs.operators, global.ng.core, global.ng.forms, global.ng.common));
}(this, function (exports, rxjs, operators, core, forms, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DynamicFormControlModel = /** @class */ (function () {
        function DynamicFormControlModel(config, layout) {
            ...
            this.disabledUpdates = new rxjs.Subject();
    ...
    var DynamicFormValueControlModel = /** @class */ (function (_super) {
        ...
        function DynamicFormValueControlModel(config, layout) {
            ...
            _this.valueUpdates = new rxjs.Subject();
            _this.valueUpdates.subscribe((/**
             * @param {?} value
             * @return {?}
             */
            function (value) { return _this.value = value; }));
            return _this;
        }
    ...
    var DynamicFormRelationService = /** @class */ (function () {
        ...
        function (model, group, control) {
             ...
             */
            function (_a) {
                var _b = __read(_a, 2), _id = _b[0], relatedControl = _b[1];
                /** @type {?} */
